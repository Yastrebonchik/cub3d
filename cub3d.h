...
void			left_half_beg(t_lin_col *lin_col, int x_cur_pos,
double *y_cur_pos, double ray_angle);
void			right_half_beg(t_lin_col *lin_col, int x_cur_pos,
double *y_cur_pos, double ray_angle);
void			up_half_beg(t_lin_col *lin_col, int y_cur_pos,
double *x_cur_pos, double ray_angle);
void			down_half_beg(t_lin_col *lin_col, int y_cur_pos,
double *x_cur_pos, double ray_angle);
...
double			vertical_raycaster(int x_pos, double y_pos,
double ray_angle, t_map *map);
double			horizontal_raycaster(double x_pos, int y_pos,
double ray_angle, t_map *map);
double			min_of_2_cub(double a, double b, t_vars *vars);
double			left_half_end(t_lin_col *lin_col, t_map	*map,
double *y_cur_pos, double ray_angle);
double			right_half_end(t_lin_col *lin_col, t_map *map,
double *y_cur_pos, double ray_angle);
double			up_half_end(t_lin_col *lin_col, t_map *map,
double *x_cur_pos, double ray_angle);
double			down_half_end(t_lin_col *lin_col, t_map *map,
double *x_cur_pos, double ray_angle);
